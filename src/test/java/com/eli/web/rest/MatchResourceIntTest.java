package com.eli.web.rest;

import com.eli.TableTennisManagerApp;
...
@SpringBootTest(classes = TableTennisManagerApp.class)
public class MatchResourceIntTest {

    private static final Integer DEFAULT_HOME_PLAYER_SETS = 1;
    private static final Integer UPDATED_HOME_PLAYER_SETS = 2;

    private static final Integer DEFAULT_AWAY_PLAYER_SETS = 1;
    private static final Integer UPDATED_AWAY_PLAYER_SETS = 2;
    ...
    public static Match createEntity(EntityManager em) {
        Match match = new Match()
            .homePlayerSets(DEFAULT_HOME_PLAYER_SETS)
            .awayPlayerSets(DEFAULT_AWAY_PLAYER_SETS);
        return match;
    }
    ...
    public void createMatch() throws Exception {
        ...
        assertThat(testMatch.getHomePlayerSets()).isEqualTo(DEFAULT_HOME_PLAYER_SETS);
        assertThat(testMatch.getAwayPlayerSets()).isEqualTo(DEFAULT_AWAY_PLAYER_SETS);
    }
    ...
    public void getAllMatches() throws Exception {
        ...
        restMatchMockMvc.perform(get("/api/matches?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].homePlayerSets").value(hasItem(DEFAULT_HOME_PLAYER_SETS)))
            .andExpect(jsonPath("$.[*].awayPlayerSets").value(hasItem(DEFAULT_AWAY_PLAYER_SETS)));
    }
    ...
    public void getMatch() throws Exception {
        ...
        restMatchMockMvc.perform(get("/api/matches/{id}", match.getId()))
            ...
            .andExpect(jsonPath("$.homePlayerSets").value(DEFAULT_HOME_PLAYER_SETS))
            .andExpect(jsonPath("$.awayPlayerSets").value(DEFAULT_AWAY_PLAYER_SETS));
    }
    ...
    public void updateMatch() throws Exception {
        ...
        updatedMatch
            .homePlayerSets(UPDATED_HOME_PLAYER_SETS)
            .awayPlayerSets(UPDATED_AWAY_PLAYER_SETS);
        ...
        Match testMatch = matchList.get(matchList.size() - 1);
        assertThat(testMatch.getHomePlayerSets()).isEqualTo(UPDATED_HOME_PLAYER_SETS);
        assertThat(testMatch.getAwayPlayerSets()).isEqualTo(UPDATED_AWAY_PLAYER_SETS);
    }
