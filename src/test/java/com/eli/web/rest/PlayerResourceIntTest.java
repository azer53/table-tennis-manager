...
public class PlayerResourceIntTest {
    ...
    private static final String DEFAULT_FRENOY_ID = "AAAAAAAAAA";
    private static final String UPDATED_FRENOY_ID = "BBBBBBBBBB";
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getFrenoyId()).isEqualTo(DEFAULT_FRENOY_ID);
        assertThat(testPlayer.getRanking()).isEqualTo(DEFAULT_RANKING);
    }
    ...
    public void getAllPlayers() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].frenoyId").value(hasItem(DEFAULT_FRENOY_ID.toString())))
    ...
    public void getPlayer() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players/{id}", player.getId()))
            ...
            .andExpect(jsonPath("$.frenoyId").value(DEFAULT_FRENOY_ID.toString()))
    ...
    public void updatePlayer() throws Exception {
        ...
        assertThat(testPlayer.getFrenoyId()).isEqualTo(UPDATED_FRENOY_ID);
        assertThat(testPlayer.getRanking()).isEqualTo(UPDATED_RANKING);
    }
